...
build-linux:
	...
	GOOS=linux GOARCH=amd64 $(GOBUILD) -o $(BIN_PATH) ./internal/ui

build-darwin-amd64:
	@echo "Building for macOS Intel..."
	@mkdir -p $(BUILD_DIR)/darwin-amd64
	GOOS=darwin GOARCH=amd64 $(GOBUILD) -o $(BUILD_DIR)/darwin-amd64/$(APP_NAME) ./internal/ui

build-darwin-arm64:
	@echo "Building for macOS Apple Silicon..."
	@mkdir -p $(BUILD_DIR)/darwin-arm64
	GOOS=darwin GOARCH=arm64 $(GOBUILD) -o $(BUILD_DIR)/darwin-arm64/$(APP_NAME) ./internal/ui
